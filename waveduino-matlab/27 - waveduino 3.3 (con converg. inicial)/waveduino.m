...
AHRScal = AHRS('SamplePeriod', dt, 'Kp', 1, 'KpInit', 1);

% Convergencia inicial
for i = 1:n
    AHRScal.UpdateIMU([0 0 0], [mean(ax) mean(ay) mean(az)]);
end

save('calibrado','tiempocal','ax','ay','az','gx','gy','gz','ac_modFilt',...
'ac_umbral','offset_gyr','graw','dt','AHRScal')
...
AHRSmedir.UpdateIMU=AHRScal.UpdateIMU;
