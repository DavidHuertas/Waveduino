...
while (get(button, 'UserData'))
    ...
    ayfilt = (1-alfa)*ayfilt + alfa*IMU(1,2);
    azfilt = (1-alfa)*azfilt + alfa*IMU(1,3);
    ...
    line([0, 0, axfilt], [0 0 0], [0 0 0], 'Color', 'b', 'LineWidth', 3,...
        'Marker', 'o');
    line([0 0 0], [0, 0, ayfilt], [0 0 0], 'Color', 'r', 'LineWidth', 3,...
        'Marker', 'o');
    line([0 0 0], [0 0 0], [0, 0, azfilt], 'Color', 'g', 'LineWidth', 3,...
        'Marker', 'o');
    line([0, 0, axfilt], [0, 0, ayfilt], [0, 0, azfilt], 'Color', 'k',...
    ...
    %Representamos la aceleración en X como un vector:
    line([0, 0, IMU(1,1)], [0, 0, 0], [0, 0, 0], 'Color', 'b',...
        'LineWidth', 3, 'Marker', 'o');
    line([0, 0, 0], [0, 0, IMU(1,2)], [0, 0, 0],  'Color', 'r',...
        'LineWidth', 3, 'Marker', 'o');
    line([0, 0, 0], [0, 0, 0], [0, 0, IMU(1,3)], 'Color', 'g',...
        'LineWidth', 3, 'Marker', 'o');
    line([0, 0, IMU(1,1)], [0, 0, IMU(1,2)], [0, 0, IMU(1,3)], 'Color',...
        'k', 'LineWidth', 3, 'Marker', 'o');
    ...
    axis square;
    grid on
    xlabel ('Aceleración sin Filtrar')
