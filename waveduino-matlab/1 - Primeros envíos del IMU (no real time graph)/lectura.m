...
valuesmatrix(5,:) = meanmatrix(5,:).*gain(3) - offset(2,2);
valuesmatrix(6,:) = meanmatrix(6,:).*gain(1) - offset(2,3);
valuesmatrix(7,:) = meanmatrix(7,:).*gain(1) - offset(3,1);
valuesmatrix(8,:) = meanmatrix(8,:).*gain(1) - offset(3,2);
valuesmatrix(9,:) = meanmatrix(9,:).*gain(1) - offset(3,3);