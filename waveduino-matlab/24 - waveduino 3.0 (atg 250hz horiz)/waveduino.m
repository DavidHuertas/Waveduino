...
function waveduino_OpeningFcn(hObject, eventdata, handles, varargin)
...
function botongrafpos_Callback(hObject, eventdata, handles)
...
function botongrafposfilt_Callback(hObject, eventdata, handles)
...
function botongrafdatos_Callback(hObject, eventdata, handles)
...
function botongrafacabs_Callback(hObject, eventdata, handles)
...
function botongrafvel_Callback(hObject, eventdata, handles)
...
function botoncal_Callback(hObject, eventdata, handles)
...
function botonini_Callback(hObject, eventdata, handles)
...
function tiempocal_Callback(hObject, eventdata, handles)
...
% --- Executes during object creation, after setting all properties.
function tiempocal_CreateFcn(hObject, eventdata, handles)
% hObject    handle to tiempocal (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function tiempocalbar_Callback(hObject, eventdata, handles)
...
% --- Executes during object creation, after setting all properties.
function tiempocalbar_CreateFcn(hObject, eventdata, handles)
% hObject    handle to tiempocalbar (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function tiempomedir_Callback(hObject, eventdata, handles)
...
% --- Executes during object creation, after setting all properties.
function tiempomedir_CreateFcn(hObject, eventdata, handles)
% hObject    handle to tiempomedir (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% --- Executes on slider movement.
function tiempomedirbar_Callback(hObject, eventdata, handles)
...
% --- Executes during object creation, after setting all properties.
function tiempomedirbar_CreateFcn(hObject, eventdata, handles)
% hObject    handle to tiempomedirbar (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function tiemporf_Callback(hObject, eventdata, handles)
...
% --- Executes during object creation, after setting all properties.
function tiemporf_CreateFcn(hObject, eventdata, handles)
% hObject    handle to tiemporf (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% --- Executes on slider movement.
function tiemporfbar_Callback(hObject, eventdata, handles)
...
% --- Executes during object creation, after setting all properties.
function tiemporfbar_CreateFcn(hObject, eventdata, handles)
% hObject    handle to tiemporfbar (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function grafcal_Callback(hObject, eventdata, handles)
